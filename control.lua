...
local processor_handlers = {
    ...
    on_built = function(event)
        ...
        local info = processor.load_stored_info(entity, true)
    ...
    on_destroyed = function(event)
        ...
        local info = processor.load_stored_info(event.entity)
    ...
    on_reoriented = function(event)
        ...
        local info = processor.load_stored_info(entity, false)
        processor.reorient_processor(info, mirroring)
    end,
}
