...
--         local class = CONNECTION_TYPES[conn._type]
...
--     return type_map[entity.type] ~= nil or type_map[entity.name] ~= nil
-- end
...
--                 local conn = factory.connections[cid]
--                 local text, noop = conn:rotate()
--                 factorissimo.create_flying_text {position = indicator.position, color = CONNECTION_TYPES[conn._type].color, text = text}
